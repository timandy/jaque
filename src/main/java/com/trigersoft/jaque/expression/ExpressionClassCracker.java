...
class ExpressionClassCracker {
    ...
    LambdaExpression<?> lambdaFromClassLoader(ClassLoader classLoader,
                                              String className,
                                              Supplier<ConstantExpression> instance,
                                              String method,
    ...
    LambdaExpression<?> lambda(SerializedLambda extracted,
        ...
        boolean hasThis = extracted.implMethodKind == MethodHandleInfo.REF_invokeInterface
                || extracted.implMethodKind == MethodHandleInfo.REF_invokeSpecial
